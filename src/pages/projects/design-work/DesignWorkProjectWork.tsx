...
function getGalleryImages(): GalleryImage[] {
  return Object.entries(projectWorkImageModules)
    .map(([modulePath, src]) => {
  ...
  return (
    <>
      ...
      <p className="page-lead">
        Selected images from past projects, including visual development, concept work, and
        production-related artwork. In some cases, only partial material can be shown due to project
        limitations or NDA restrictions.
      </p>
      ...
      {selectedImage && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Project Work image viewer"
