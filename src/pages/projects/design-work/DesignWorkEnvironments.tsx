...
function getGalleryImages(): GalleryImage[] {
  return Object.entries(environmentImageModules)
    .map(([modulePath, src]) => {
  ...
  return (
    <>
      ...
      <p className="page-lead">
        A selection of personal environment and concept design studies, covering architecture, interior
      ...
      {selectedImage && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Environments image viewer"
